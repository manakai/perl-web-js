...
=item $defs = $processor->definitions
...
The definitions data structure is a hash reference, with key/value
pairs where keys are names of definitions and values are their
descriptions.
