...
The type of the parameterized type, such as C<sequence>, if the hash
reference containing the key/value pair represents a parameterized Web
IDL type of the target.
