...
Type of the definition: C<interface>, C<class>, C<dictionary>,
...
C<serializer>, C<iterable>, C<legacyiterable>, C<maplike>, C<setlike>,
or C<dictionary_member>.
...
=item getter, setter, deleter, stringifier, serializer
